...
hacker@permissions~permissions-setting-practice:~$ chmod 311 /challenge/pwn
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod 774 /challenge/pwn
You set the correct permissions!
Round 3 of 8!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod 760 /challenge/pwn
You set the correct permissions!
Round 5 of 8!
...
- the world doesn't have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod 161 /challenge/pwn
You set the correct permissions!
Round 7 of 8!
...
* the world does have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod 523 /challenge/pwn
You set the correct permissions!
Round 8 of 8!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod 344 /challenge/pwn
You set the correct permissions!
...
pwn.college{wLiFgWAz3Zm-1ZjQB0Y6vEPts0e.QXzETO0wiM1kjNzEzW}
```
